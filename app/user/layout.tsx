...
export default function RootLayout({
  ...
  const res = await fetch(`https://blesstours.onrender.com/api/v1/users/${session?.user.data.id}`, {
      method: "GET",
      headers: {
            ...
            <div
              ...
              <div className="p-3 sm:p-4 lg:p-6 rounded-2xl bg-white shadow-lg">
                ...
                <div className="text-center mb-10">
                  <h4 className="text-2xl font-semibold">  {userData?.EMAIL} Savannah Nguyen </h4>
